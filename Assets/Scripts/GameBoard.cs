...
public class GameBoard : MonoBehaviour
{
    ...
    private void SelectChessman(int x, int y)
    {
        ...
        Move.Instance.HighLightAllowedMoves(allowedMoves);
    ...
    void UpdateCamPositions() {

        //Debug.LogError("White Turn = " + isWhiteTurn);

        if (isWhiteTurn)
            cameraScript.SetPosition(whiteTurnCamPosition);
        else 
            cameraScript.SetPosition(blackTurnCamPosition);
    }
}
